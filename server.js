...
const firebaseConfig = {
  apiKey: "AIzaSyCFNwQNBlsGw1beLkbFKnJfBVgCy5mxTMs",
  authDomain: "premium-5477d.firebaseapp.com",
  projectId: "premium-5477d",
  storageBucket: "premium-5477d.appspot.com",
  messagingSenderId: "877955949996",
  appId: "1:877955949996:web:e8bd44acd1fb1f4e580609"
};
...
app.use(express.json())//enable from sharing
...
const bucketName = "diplomka-furniture";
...
app.post('/add-product', (req, res)=>{
    ...
    if(!draft){
        if(!name.length){
            ...
            res.json({'alert':'short desc must be 80 letters long'});
...
app.post('/add-review', (req, res)=>{
    ...
    }).catch(err => res.json({'alert': 'some err occured'}));
})
